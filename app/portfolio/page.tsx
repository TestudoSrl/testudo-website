        ...
        <div className="w-full max-w-7xl p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col transition-all duration-300 hover:bg-orange-500 hover:scale-105 hover:shadow-xl">
              <h2 className="text-xl font-bold text-black text-left mb-4">Salute / Automazione ordini</h2>
            ...
            {/* Card 2 */}
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col transition-all duration-300 hover:bg-orange-500 hover:scale-105 hover:shadow-xl">
              <h2 className="text-xl font-bold text-black text-left mb-4">Finanza / Document Capture Platform</h2>
              <p className="text-gray-600">
            ...
            {/* Card 3 */}
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col transition-all duration-300 hover:bg-orange-500 hover:scale-105 hover:shadow-xl">
              <h2 className="text-xl font-bold text-black text-left mb-4">Assicurazioni / Business Communication Platform</h2>
              <p className="text-gray-600">
            ...
            {/* Card 4 */}
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col transition-all duration-300 hover:bg-orange-500 hover:scale-105 hover:shadow-xl">
              <h2 className="text-xl font-bold text-black text-left mb-4">Automobilistico / Automazione ciclo passivo</h2>
              <p className="text-gray-600">
            ...
            {/* Card 5 */}
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col transition-all duration-300 hover:bg-orange-500 hover:scale-105 hover:shadow-xl">
              <h2 className="text-xl font-bold text-black text-left mb-4">Assicurazioni / Document Capture Platform</h2>
              <p className="text-gray-600">
            ...
            {/* Card 6 */}
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col transition-all duration-300 hover:bg-orange-500 hover:scale-105 hover:shadow-xl">
              <h2 className="text-xl font-bold text-black text-left mb-4">Viaggi / Business Communication Platform</h2>
              <p className="text-gray-600">
